...
export default function Testimonials() {
    ...
    return (
        <div className="snap-start h-screen w-screen overflow-x-hidden mt-10 font-body">
            <section
                id="testimonials"
                className="flex justify-center items-center px-8 py-12 bg-transparent h-screen w-screen overflow-x-hidden"
            >
                <div className="max-w-7xl xl:max-w-5xl lg:max-w-3xl mx-auto flex items-center">
                    <div className="w-3/4 pl-4">
                        <h2 className="text-2xl font-bold mt-8 text-white tracking-[.10em]">
                            TESTIMONIALS
                        </h2>
                        <h2 className="text-6xl font-bold mt-8 text-zinc-400 tracking-[.10em] font-heading">
                            TOTEM
                        </h2>
